...
def find_and_download_songs(reference_file: str):
    ...
    with open(reference_file, "r", encoding='utf-8') as file:
        for line in file:
            ...
            text_to_search = artist + " - " + name + ' audio'
            best_url = None
            ...
            while attempts_left > 0:
                try:
                    ...
                    print(results_list[0]['url_suffix'])
                    break
                except IndexError:
                    attempts_left -= 1
...
if __name__ == "__main__":
    ...
    client_id = 'b419c5a6c9644b929e0bdc1be3e50c36'
    client_secret = 'fa1fa070b98e44ffb7b9fce9249054f8'
    username = 'Hailin Wang'
    playlist_uri = '37i9dQZF1DXdxUH6sNtcDe'
